...
(For the otherwise confused, I do not advocate that people individually refuse to avail themselves of pre-superintelligent AI or AGI.  Because AI is not a linear system where slightly less  input results in slightly less damage; because the "now you have to pay us $20/month or fall behind" trap is real; and because I personally think it wise to learn and understand the frontiers in whatever ways I most easily find energy to invest there.  I would give it all up in a heartbeat if there were an effective and collective treaty to stop it all at once.  Don't be the "Yet you participate in the system. Curious!" meme.)
