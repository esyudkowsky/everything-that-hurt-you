# voice-script.md — per-line emotional states
...
*actually feeling* internally when they said it, and — separately, where the two
differ — *how they wanted to appear to others*. This is for an experiment (author,
2026-07-08): giving a voice model descriptions of inner state instead of instructions
about intonation or delivery.

**Deliberately absent.** This document contains NO direction about how to speak: no
pacing, volume, tone, or delivery instructions. Each entry only describes (a) the
character's internal feeling, and (b) where different, the feeling they want others to
see. Whether description alone produces better voice acting than explicit direction is
the thing being tested.

**Conventions.**
- `|` inside a quoted line is a pause marker in the script text, not something read aloud.
- Lines whose entire text is `...` are silent panels — nothing is spoken. They are
  included (marked *silent*) as descriptions of the character's state during the pause.
- Third-person narration lines and on-screen text (`@overlay` blocks, the pamphlet
  title) are not dialogue and are excluded. If narration is ever voiced, it belongs to
  Skagganauk.
...
to act on it, because she cannot meaningfully consent while collared. Baseline: he feels
much more than he shows, and he wants to appear controlled, unremarkable, and
unreadable. When his control fails, what comes through is sadness, not anger.
...
routine, and one allowed kind of distress — worry that she is not serving well. Her
early cheer is real but shallow. She never feels sadness before the collar comes off.
After the collar comes off (chapters 11–12), all the suppressed pain returns; what is
underneath is tired, dry, precise, and genuinely fond of Avram. She is 23. At the cliff
she has already decided to die, is calm about it, and sincerely forgives him.
...
knows how this story ends. Baseline: calm, patient, never hurried, emotionally distant
but not cold. At the very end he feels warmth and hope for the first time.
...
All chapter 1 lines are Skagganauk. Overall state: calm, ancient, patient, telling a
story he already knows is sad. He feels no urgency anywhere.

- **Skagganauk:** "I tell you now a tale of the planet, Elhom IV."
  - *feeling:* calm and formal; the settled contentment of a storyteller beginning.
- **Skagganauk:** "The world of Elhom IV has a cycle."
  - *feeling:* patient; this is a very familiar fact to him.
- **Skagganauk:** "From time to time, arises a Demon Lord, feared and accursed."
  - *feeling:* neutral; he feels no fear of Demon Lords and no wish to frighten.
- **Skagganauk:** "And another rises to fight them."
  - *feeling:* even, matter-of-fact.
- **Skagganauk:** "The great, the powerful, the Summoned Hero."
  - *feeling:* respectful but unimpressed; he has recited these titles many times.
- **Skagganauk:** "They are not supreme when they first arrive."
  - *feeling:* mild, gentle amusement.
...
- **Skagganauk:** "And they gain in strength very quickly."
  - *feeling:* certainty; he considers this the most important fact so far, though not a frightening one.
- **Skagganauk:** "Sometimes, the outsiders are summoned from lands that tell stories of places like Elhom IV. It leaves less to explain."
  - *feeling:* very slight amusement; otherwise even.
- **Skagganauk:** "There is much about Elhom IV that Avram Detwiler finds strangely familiar."
  - *feeling:* his interest rises a little as he names the protagonist; still calm.
- **Skagganauk:** "But what Avram has not been told, it seems,"
  - *feeling:* deliberate anticipation; he knows the next fact is the important one.
- **Skagganauk:** "Is that there are always two outsiders Summoned, not one."
  - *feeling:* seriousness and weight, for this one line; then he lets it go.
...
- **Avram:** "Glass of traveler's mead."
  - *feeling:* tired from the road; alert and watchful; he is really here to gather information, not to drink.
  - *wants to appear:* an ordinary, forgettable customer.
- **Bartender:** "Eight copper."
  - *feeling:* bored; no interest in the customer.
- **Avram:** "Got a rumor I'd like to check on."
  - *feeling:* slightly tense; this question matters to him a great deal.
  - *wants to appear:* idly curious.
...
- **Avram:** "Not that kind of rumor - look, I'm not sure there's anything to this. Could just have been a guy messing with another guy. | But have you heard anything about a rising Demon Lord?"
  - *feeling:* tense; he already knows the rumor is true and needs to learn how far it has spread.
  - *wants to appear:* slightly embarrassed to be asking; ready to laugh the whole thing off.
- **Bartender:** "Aw *slimespit.*"
  - *feeling:* sudden real fear; dismay.
- **Bartender:** "What'd you hear, kid? Tell me everything. Now."
  - *feeling:* frightened and urgent.
  - *wants to appear:* intimidating and in control.
- **Avram:** "I just heard some guy talking about it! That's why I'm asking whether -"
  ...
  - *wants to appear:* an innocent bystander with nothing to hide.
- **Bartender:** "Some guy *where* saying *what?*"
  - *feeling:* still scared; needing answers.
- **Avram:** "Some guy in the middle of nowhere who I heard say something about a Demon Lord! That's all I heard, okay? | I know practically nothing. That's why I'm *asking.*"
  - *feeling:* stressed; improvising a cover story under pressure, and picking words so that it is technically true.
  - *wants to appear:* exasperated and innocent.
- **Avram:** "If the Demon Lord has shown up, I'd really like to know where they are, what they're doing."
  ...
  - *wants to appear:* a sensible traveler being prudent.
- **Avram:** "Whether their forces are invading here tomorrow."
  - *feeling:* serious; the danger is concrete to him.
  - *wants to appear:* mildly wry, keeping it hypothetical.
- **Avram:** "That kinda thing."
  - *feeling:* wanting to lower the temperature after raising it; still watchful.
  - *wants to appear:* casual, indifferent.
...
- **Bartender:** "I wouldn't be staying on the same continent if I'd heard the next Demon Lord had shown up here, ya know?"
  - *feeling:* candid; calming down; comfortable with his own survival policy.
...
- **Avram:** "Yeah, I know."
  - *feeling:* privately noting that ordinary people flee from Heroes too; a small hidden heaviness.
  - *wants to appear:* idly agreeing, half paying attention.
- **Avram:** "Probably a dumb question, but if a guy runs across an unusual drop, is there any more profitable and sophisticated thing to do with it than flipping it to the Guild buyers?"
  - *feeling:* focused; he is planning how to pay for something expensive.
  - *wants to appear:* a naive newcomer asking about money.
- **Bartender:** "Guess what, kid? | You're right. | That is a dumb question."
  - *feeling:* enjoying himself; teasing; his earlier fear entirely forgotten.
- **Bartender:** "Better hope nobody overheard it."
  - *feeling:* mostly mockery, with a small sincere warning underneath.
- **Avram:** "You know, maybe this is another stupid thought. Feel free to tell me why it's stupid."
  - *feeling:* focused and serious; he is about to describe his real life plan and wants it criticized if it is wrong.
  - *wants to appear:* idly philosophizing over a drink.
- **Avram:** "But if Summoned Heroes are supposed to learn so fast, why don't they just stay hidden and keep leveling to the point where they can take out the Demon Lord quickly and without wrecking a continent?"
  - *feeling:* strong conviction, plus some anxiety that his plan has a flaw he cannot see.
  - *wants to appear:* someone posing a hypothetical, nothing personal.
- **Avram:** "Like, geez, have some consideration for everybody who lives there."
  ...
  - *wants to appear:* jokingly exasperated.
...
- **Avram:** "That's the only reason you can think of for why the Summoned Hero doesn't do that? It's not heroic enough?"
  - *feeling:* pressing for a real objection; growing relief that he keeps hidden — if this is the best counterargument, his plan is sound.
  - *wants to appear:* mildly enjoying a debate.
...
- **Avram:** "One might argue that the Summoned Hero ought to take pride in carefully executing their responsibility, to everyone in the world, to defeat the Demon Lord with minimum casualties and risk of failure."
  - *feeling:* this is his sincere personal creed; quiet passion underneath.
  - *wants to appear:* detached, making an impersonal argument.
- **Bartender:** "Sounds more like a villain's style to me."
  - *feeling:* cheerful and offhand; he attaches no weight to this remark.
- **Bartender:** "If you think like that, the Summoned Hero ought to buy a high-level fighting slave and get carried through dungeons, like a sheltered noble scion, right? To avoid the risk that they get killed while they're still weak?"
  - *feeling:* having fun building what he considers an absurd example; mildly pleased with himself. He has no idea he is describing what Avram is about to do.
- **Bartender:** "But people like that aren't *heroes.* They'd never work up the courage to face the Demon Lord in the end."
  - *feeling:* warm, dismissive satisfaction; wrapping up his argument.
- **Avram:** "..." *(silent panel)*
  - *feeling:* chilled and shaken. The bartender has just described his entire plan and called it cowardly and villainous, and he is going to do it anyway.
...
- **Announcer:** "A *war*-slave, sers! Blooded on the low floors, sound of wind and limb — wolf-blood stock, twice as hardy as any human and worth three warriors on a campaign!"
  - *feeling:* bored; this is routine work; no cruelty and no sympathy.
  - *wants to appear:* an exciting showman making merchandise attractive to a crowd.
- **Announcer:** "[Ownership Transfer.]"
  - *feeling:* nothing; an official formula he has recited thousands of times.
...
- **Avram:** "So. Um. I bought you to help me clear dungeons. And help teach me to fight. | I'm not planning to sexually assault you."
  - *feeling:* deeply ashamed and uncomfortable; tense; aware his rehearsed speech is coming out wrong.
  - *wants to appear:* calm and businesslike.
- **Avram:** "You didn't *look* like the prospect of risking your life in a dungeon would horrify you to the point where you'd rather have gone with the other guy instead."
  - *feeling:* anxious; justifying the purchase to her and to himself.
  - *wants to appear:* reasonable and transparent.
- **Avram:** "It *looked* like you'd be better off with me. Like your life would be - better for my buying you, than my not buying you, if those were your only two options."
  - *feeling:* uneasy; restating the moral reasoning he used and checking that it still holds; he flinches inwardly at his own arithmetic.
  - *wants to appear:* careful and fair.
...
- **Her:** "Helping you clear dungeons is fine, Master! | Is there a reason you wouldn't also have sex with me?"
  - *feeling:* relieved to have a clear assignment; then genuinely confused by his unusual terms — an unexplained oddity in a master feels dangerous to her. The question is practical, not shy and not seductive.
  - *wants to appear:* bright, cheerful, at ease.
- **Avram:** "It's - against the customs of my people."
  - *feeling:* cornered; retreating to a prepared cover story; discomfort spiking.
  - *wants to appear:* someone stating a mild cultural fact.
- **Avram:** "Are you hungry? Do you need a shower, or a doctor, or new underwear, or - or anything at all?"
  - *feeling:* guilty and slightly frantic; an urgent need to do something kind immediately.
  - *wants to appear:* practical, handling logistics.
- **Her:** "No, Master. | I was fed just yesterday."
  ...
  - *wants to appear:* cheerful and easy to keep.
- **Avram:** "God. | How the hell do I say this? Do this?"
  - *feeling:* dismayed and shaken by her last answer; momentarily talking to himself rather than to her.
- **Avram:** "Um."
...
- **Avram:** "I want you to have an experience that is... as comfortable as it can be under these circumstances."
  - *feeling:* strained; choosing each word very carefully; he cannot bring himself to name slavery directly.
  - *wants to appear:* considered and gentle.
- **Avram:** "I don't mean that I'm ordering you to pretend to be happy."
  - *feeling:* anxious; urgently heading off a failure mode he fears.
- **Avram:** "Just... please let me know, how we can do this, in a way that minimizes fear and uncertainty for you. | On the inside."
  - *feeling:* earnest and careful; this is the actual request.
...
- **Avram:** "And the *point* of this whole concept is to make things easier on you, which means, I'm *not* going to punish you if you don't get it right."
  - *feeling:* worried that he will not be believed.
  - *wants to appear:* patient and clear.
- **Her:** "Master's wishes... are my command? | I'm not sure I understand Master's wishes, though."
  ...
  - *wants to appear:* dutiful and willing.
- **Avram:** "That's fine."
  - *feeling:* softening; relieved that she said something honest.
- **Avram:** "Next we're going to the finest restaurant in this town and eating a nice meal together, including any of your favorite foods that are on the menu regardless of what they cost."
  - *feeling:* relieved to have found a concrete kindness he can actually do; some warmth.
- **Avram:** "And, if it's okay with you, I'd rather you didn't say anything about how grateful you are for such kindly treatment from me."
  ...
  - *wants to appear:* mild and apologetic about an odd request.
...
- **Avram:** "I mean, I *wish* I could say, it's okay for you to thank me if you want to. | But I won't actually be able to avoid looking horribly uncomfortable if you do."
  - *feeling:* honest and a little embarrassed; admitting his own limits; slightly self-mocking. For once he is not hiding much.

*(Naming beat, same chapter — town gate.)*

- **Avram:** "So. What do I call you? What's your —"
  - *feeling:* light and hopeful; trying for a normal getting-to-know-you moment.
- **Her:** "Whatever Master likes! A slave's name is her master's to give."
  - *feeling:* this is the only time in the whole story she interrupts him. A sudden, strong, reflexive urge to be helpful right now — underneath it is trained avoidance of her old name, a topic she was tortured over, but she does not consciously feel that; she only feels the urgency.
  - *wants to appear:* extra-bright and eagerly helpful.
...
- **Her:** "This says my name is #3,907,825. That's a lot of syllables for a dungeon, Master. You should pick something shorter."
  - *feeling:* an urge to move quickly away from this topic by making it practical and funny; she is not aware of why she needs to move away from it.
  - *wants to appear:* bright, clever, playful.
...
- **Avram:** "...I'll think on it."
  - *feeling:* deciding not to push; gentle; a little troubled.
...
- **Avram:** "I'll live."
  - *feeling:* guarded and wary of where this is going; also genuinely cold and tired.
  - *wants to appear:* stoic and indifferent.
...
- **Avram:** "..." *(silent panel)*
  - *feeling:* reluctantly recognizing that her argument is sound; weighing principle against being cold all night.
- **Avram:** "...Fine. Warmth only."
  - *feeling:* giving in on the small point while holding the larger boundary firmly; tense about the boundary.
...
- **Avram:** "No."
  - *feeling:* absolute refusal that costs him real effort — he is attracted to her and is refusing himself, not just her.
  - *wants to appear:* calm and final, not tempted.
...
- **Avram:** "We've been lucky."
  ...
  - *wants to appear:* modest, mildly wry.
...
- **Avram:** "She's with me."
  ...
  - *wants to appear:* neutral and indifferent.
...
- **Adventurer 2:** "Maybe his sword arm's the only arm that works!"
  - *feeling:* very pleased with his own joke.
- **Adventurer 1:** "It's cruelty is what it is. Girl like that, and he makes her sleep *cold*."
  - *feeling:* having fun.
  - *wants to appear:* mock-serious, like a lawyer making a solemn accusation.
- **Her:** "I don't sleep cold. Master shares the bedroll."
  - *feeling:* cheerfully correcting a factual mistake about her master's care; mostly interested in her food. The sexual implication does not exist for her; she is completely sincere.
...
- **Adventurer 1:** "That's not a monk, that's a *saint*. Or a corpse."
  - *feeling:* amazed and delighted; this is a story he will retell for years.
- **Avram:** "We're done."
  - *feeling:* alarmed — the table just advertised his strangeness to a crowded room — plus plain embarrassment.
  - *wants to appear:* bored and done with the conversation.
- **Her:** "Goodnight, sers!"
...
- **Her:** "Did I say something wrong, Master?"
  - *feeling:* real worry — anxiety about having made an error, the one kind of distress she is able to feel.
- **Avram:** "No."
  - *feeling:* protective; none of this is her fault.
- **Avram:** "Yes."
  - *feeling:* correcting himself a moment later, because he will not lie to her; this answer weighs on him more than the first.
- **Avram:** "We don't want to look anomalous."
  - *feeling:* serious and tired; the real danger behind this rule is much larger than he can explain.
- **Her:** "Yes, Master."
  - *feeling:* slightly relieved; a clear correction is easier for her than an unreadable master.
- **Avram:** "..." *(silent panel)*
  - *feeling:* aware that he has again given her a rule with no reasons; unhappy about the pattern.
- **Her:** "..." *(silent panel)*
  - *feeling:* patiently holding an unspoken thought.
...
- **Her:** "We'd look less like an anomaly if you told them you were fucking me."
  - *feeling:* matter-of-fact; offering a practical solution to the problem he named; slightly pleased with its neatness. No flirtation.
- **Avram:** "I hate lying and somebody with superior Social Skills might catch me at it."
  - *feeling:* careful; the answer is true, but he is also using it to avoid the deeper question.
- **Her:** "And there's an obvious solution to that too, so why don't you?"
  - *feeling:* calm, genuinely curious; aware she has him cornered logically.
- **Her:** "I don't understand. You have the rights to my body and I'd be happier too."
  - *feeling:* earnest confusion; "happier" is sincere — it would resolve her worry about being inadequate and make the relationship understandable to her. A little plaintive underneath. Not seductive.
- **Avram:** "It's -- the customs of my people."
  - *feeling:* strained; he knows the excuse is wearing out.
  - *wants to appear:* someone repeating a mild cultural fact.
- **Her:** "Their customs obviously allow people to fuck under some circumstances or you wouldn't be here, Master."
  - *feeling:* pleased with her own logic; lightly teasing; enjoying the conversation.
- **Avram:** "...It's a subject we could revisit later under different circumstances."
  - *feeling:* careful; buying time; choosing words very deliberately.
- **Her:** "When, Master?"
...
- **Avram:** "When I've become strong enough to defeat you in a duel, easily, ten times out of ten."
  - *feeling:* sadness and tenderness underneath — this condition secretly marks the date he will free her; he knows what it means and she does not.
  - *wants to appear:* someone solemnly stating a strange foreign custom.
- **Her:** "Your mysterious people's customs say you have to conquer me fairly to have the right to take me?"
  - *feeling:* amused skepticism; she does not believe the framing but accepts it; satisfied to finally have a concrete rule with a date attached.
- **Avram:** "Something like that."
  - *feeling:* a small ache; wanting the topic closed gently.
  - *wants to appear:* unreadable and calm.
...
- **Healer:** "Your slavegirl's not happy, young man. | She's trying to hide it, but not well enough to fool my level of social Skills."
  - *feeling:* dry; she dislikes slave-owners and is testing what kind this one is; watching his reaction closely.
- **Avram:** "What's wrong?"
  - *feeling:* instant, unguarded concern; for once he forgets to hide anything.
...
- **Healer:** "I'm telling you this much, because my Skill judges it'll do her more good than harm for you to know. Don't prove me wrong."
  - *feeling:* firm; her sympathy is with the girl; the last sentence is a genuine warning.
- **Avram:** "It isn't about her. There's a reason and it's a good one."
  - *feeling:* stung and defensive, because the diagnosis is accurate and he cannot fix it without revealing his secret.
  - *wants to appear:* calm and assured.
- **Healer:** "Like what?"
  - *feeling:* unimpressed; giving him a chance she expects him to refuse.
- **Avram:** "Private."
  - *feeling:* miserable behind a wall; he keeps it to one word because more would crack his composure.
  - *wants to appear:* flatly final.
- **Healer:** "Well if you won't tell even her, that sounds to her like you're planning to sell her off, hm? Not settling down for the long run with her."
  - *feeling:* deliberately pressing on his conscience, because she has spotted that he has one.
- **Avram:** "..." *(silent panel)*
...
- **Bandit:** "Easy now. Lay down weapons. | No need for anyone to die today."
  - *feeling:* relaxed and confident; routine work with a numbers advantage.
  - *wants to appear:* soothing and reasonable, a man offering an easy way out.
- **Avram:** "We've no wealth worth your risk."
  - *feeling:* adrenaline rising; counting enemies and planning while he talks.
  - *wants to appear:* calm; a poor, boring target.
...
- **Her:** "Master. I don't think you should. | They have the air of slavetakers about them."
  - *feeling:* alarmed and protective — fear for him, not for herself — plus professional certainty about what she is seeing. All cheer gone.
...
- **Avram:** "Then I suppose you will be the first to die by my hand. | I hope you end up somewhere else, but not anywhere you'll be important."
  - *feeling:* sad and certain. He has never killed anyone, has just decided to, and is already grieving it. The second sentence is a sincere, odd kindness — he personally knows death may not be the end. No anger and no wish to intimidate.
- **Slavetaker:** "Code black!"
  - *feeling:* shock and fury — his men are dying and the plan has failed; an emergency order.
- **Slavetaker:** "Stupid fucking bitch -- you were worth money too, you know! I'm going to make you regret that really fucking badly, before you finish dying --"
  - *feeling:* rage turning cruel; he has lost money and men and wants to hurt someone.
...
- **Avram:** "She saved my life. | I'd save hers whether I was attached to her or not."
  - *feeling:* exhausted and hollow after hours at her bedside; also dodging the word "attached," which is truer than he wants to admit.
  - *wants to appear:* acting on principle rather than feeling.
...
- **Attendant:** "That poor, poor girl."
  - *feeling:* sincere pity — by her worldview, a kind master is bad for a slave in the long run because he teaches her to hope.
- **Her:** "The slavetakers —"
  - *feeling:* waking disoriented and urgent, still mentally in the fight.
- **Avram:** "Gone. Don't move."
  - *feeling:* intense relief held tightly under control; protective.
...
- **Her:** "Yes, master."
  - *feeling:* worried and vigilant; she will watch every second of the fight, ready to move.
  - *wants to appear:* simply obedient.
- **Her:** "Your strength has risen, Master."
  - *feeling:* professional assessment plus a teacher's pride; warm. Underneath, awareness that his promised condition is getting close.
- **Avram:** "Getting there."
  - *feeling:* grim satisfaction; he is tracking a much bigger goal than she knows.
  - *wants to appear:* modest and offhand.
...
- **Adventurer 6:** "That's got to be the most frustrating thing in the world, ain't it? The literal actual legendary Hero right there in camp with you and you're not getting it on."
  - *feeling:* sincere drunken sympathy for men he has never met; completely oblivious that he is also describing the man at the counter.
- **Avram:** "..." *(silent panel, at the counter, profile)*
  - *feeling:* cold shock arriving in stages: the other summoned outsider is real, publicly visible, and following the exact same strategy he is — which means his own behavior pattern is recognizable. Very still, thinking hard.
  - *wants to appear:* just a man reading a notice board.
...
- **Avram:** "I think I'm stronger than you, now. Am I correct?"
  - *feeling:* dread; he knows this question starts something she is not expecting.
  - *wants to appear:* calm, almost formal.
...
- **Avram:** "This is a very serious question."
  - *feeling:* grave; wincing inwardly at her hope; wanting to slow everything down.
- **Avram:** "If you lie about it, if you're pretending to be weaker than you are, to make me feel better, I could *die.*"
  - *feeling:* intense; this is literally true, and he is also making the stakes heavy enough that her urge to please cannot bend her answer.
- **Avram:** "Am I strong enough to beat you easily in a real fight?"
  - *feeling:* braced; this question decides everything.
- **Her:** "I don't understand."
  - *feeling:* confused; his seriousness does not match what she thought tonight was about; a first hint that something is wrong.
- **Avram:** "That's fine. Just answer the question with the complete truth."
  - *feeling:* kind but procedural; he cannot explain without influencing her answer.
- **Her:** "You seem strong enough to defeat me easily, Master, ten times out of ten. | Even taking into account that you'd be using your magic to make up for having less life-or-death combat experience."
  - *feeling:* careful professional assessment; precise because her expertise is real; she believes this answer unlocks what she wants.
- **Avram:** "Okay. I didn't want to say this - before - it seemed cruel to say it before I was ready to do it."
  - *feeling:* committed now; grief already present; hesitant, checking each phrase for cruelty before using it.
- **Avram:** "But I always planned, as soon I was strong enough to survive without your protection, to free you."
  - *feeling:* wretched but resolved; he watches the words hurt her as he says them.
- **Her:** "Oh... oh."
  - *feeling:* shock; the structure her world depends on is being removed, and the collar's conditioning does not even let her form the protest clearly.
- **Her:** "I'm fine being your slave, Master. You don't have to -"
  - *feeling:* fear, coming out as reassurance because that is the only form her conditioning allows.
  - *wants to appear:* brightly content, as if nothing is wrong.
- **Avram:** "I really, really have to."
  - *feeling:* pained but absolute.
- **Her:** "Master, I - like the way things have been with you. You're very mighty and wise, and I'm proud to be your slave. | I would rather that things just stay as they are."
  - *feeling:* as close to open pleading as she is capable of; dignity and fear together; the stumble at "I - like" happens because the sentence contains a real personal feeling and she has no practice stating those. Underneath: in her experience, change has always meant catastrophe.
  - *wants to appear:* composed and respectful, stating a preference.
...
- **Avram:** "Not this collar, not a magical slave collar."
  - *feeling:* anxious not to be misunderstood on exactly this point.
- **Avram:** "It's - something of a sacred rite among my own people, when somebody steps forward to receive a collar from the one they love, that they name their master of their own will."
  - *feeling:* embarrassed and deeply sincere at once; describing something tender from his home world; this is as close to a declaration of love as he can manage.
- **Her:** "So just leave the collar on me, then?"
  - *feeling:* bargaining; desperate underneath; she wants any version of this where nothing changes.
  - *wants to appear:* reasonable, offering a sensible compromise.
- **Avram:** "Yeah, see, the part where they step forward of their own will is important. This collar is *not that.* From my perspective it's a horrific blasphemy."
  - *feeling:* real anger finally showing — aimed at the collar and the world that made it, never at her.
- **Her:** "Take the collar off, then put it back on me again right away?"
  - *feeling:* scrambling for another workaround; panic underneath.
  - *wants to appear:* bright and helpfully problem-solving.
...
- **Avram:** "Even if you say it's not doing that, you might just be saying what the collar programmed you to say. | Or thinking what you subconsciously believe I wish you'd think."
  - *feeling:* weary; he has run through these loops many times in his head.
...
- **Avram:** "Once you've been free for a month, I'll trust that you've had time to get used to freedom, and making your own decisions."
  - *feeling:* solemn; reciting the plan that makes real consent possible; hope hidden inside the procedure.
- **Avram:** "If you still want to be my slave then, or just to kiss me, I won't say no."
  - *feeling:* his most exposed moment: real longing, allowed out for one sentence; "or just to kiss me" is hard for him to admit.
- **Her:** "Is this... truly your desire, Master? Truly?"
  - *feeling:* the closest her conditioning lets her come to saying "please don't do this"; checking twice, hoping for an exit.
- **Avram:** "What I want has surprisingly little to do with any of this."
  - *feeling:* bleak; what he wants is her, and he will not let that decide anything.
- **Her:** "Was I not a good enough slave?"
  - *feeling:* genuine hurt, in the one shape her conditioning permits: fear of inadequacy.
...
- **Avram:** "Look, I'm sorry, I've tried to avoid giving you explicit orders, but - this isn't optional."
  - *feeling:* apologetic and unbending at the same time; he is breaking his own rule against giving orders, and hates it, in order to end all orders.
- **Avram:** "Come here and stand still while I remove your collar."
  - *feeling:* grief, held down hard so that he can get through the sentence.
  - *wants to appear:* steady and certain.
- **Avram:** "You can take some time to think, if you need to."
  - *feeling:* hollow and helpless; with the collar off he suddenly cannot read her at all.
- **Avram:** "I'll be around if you want to talk to me."
  - *feeling:* aching; wanting to leave every opening he can.
- **Avram:** "If you need to - say anything to me."
  - *feeling:* close to breaking; "anything" includes screaming at him or hating him — he would accept all of it.
...
What is underneath: tired, dry, precise, kind, and calm — she has already decided to
die and is at peace with the decision. He suspects what the cliff means and will not use
force or authority to stop her; that refusal costs him everything.

- **Avram:** "Sorry for - interrupting you - but I felt you climb up here. My magical senses extend a long ways, now."
  - *feeling:* deep fear — he knows what a cliff might mean — and an overriding wish not to startle or pressure her.
  - *wants to appear:* apologetic, casual, harmless.
- **Avram:** "It's a funny thing, I have all sorts of guesses about what you might say, and they all terrify me, and I need to hear it anyways."
  - *feeling:* honest fear, openly admitted; he has stopped performing anything.
- **Avram:** "You can slap me for having the temerity to say this, if you want to. | But even so, I'm sorry."
  - *feeling:* a long-carried apology finally spoken; braced for anger.
- **Her:** "You weren't so bad. | It's not a lie that you were the best master I've ever had."
  - *feeling:* tired kindness; carefully exact — she gives him only as much comfort as is honestly true.
- **Her:** "If it had only ever been you, I might be able to - live with it."
  - *feeling:* calm about something enormous; explaining her decision; a hesitation before "live with it."
- **Her:** "The collar punished me. Like a centipede crawling in my brain and biting me when I thought anything it didn't like."
  - *feeling:* giving testimony about torture; tired, precise, past drama.
- **Her:** "Every time I thought how much I hated it."
  - *feeling:* listing things she was never allowed to say; even and flat inside.
- **Her:** "Every time I thought how much I didn't want to keep living."
  - *feeling:* the same evenness — to her, this item is no bigger than the others.
- **Her:** "Every time I resented being punished."
  - *feeling:* a trace of old, dry disbelief that the punishment covered even resenting punishment.
- **Her:** "They left me in a cell to scream for weeks while that part worked itself out. Some people in the cells just died that way."
  - *feeling:* her worst memory, held at a distance; stating facts.
- **Her:** "I managed to stop thinking the bad thoughts, and then things were better."
  - *feeling:* grim accuracy about what survival cost; no sarcasm.
- **Her:** "I just kept going and never had to think at all about how much I hated it."
  - *feeling:* conclusive; this is the explanation of her whole earlier cheerfulness.
- **Avram:** "I was... afraid... it was, it was, it was something like that..."
  - *feeling:* devastated; his worst guesses confirmed and worse; grief, horror, and guilt all at once.
- **Her:** "And now you took off the collar and I can't. Can't stop. Can't stop thinking about it."
  - *feeling:* the suppressed pain flooding back and overwhelming her calm for the first time; urgency and distress.
- **Avram:** "Do you - I want to say this, but, I don't know if I have your permission to say it -"
  - *feeling:* careful and hesitant; genuinely asking her permission to speak, and meaning it.
- **Avram:** "Do you know the reason I did it, or my excuse, for making you fight with me and protect me? Instead of freeing you right after I bought you?"
  - *feeling:* unsteady; he honestly downgrades "reason" to "excuse" as he says it; he needs her to have the whole truth.
- **Her:** "If it's what I think it is, I guessed the first week after you bought me. | I didn't say it because it seemed like you didn't want me to, and Master's wants are absolute."
  - *feeling:* faint dry humor, even now; the last phrase carries mild irony and is also simply how her world worked.
- **Avram:** "I'm the Summoned Hero."
  - *feeling:* the secret of two years finally released; relief and shame together; no drama left in him.
- **Her:** "No, really? You seemed like such an inhabitant of this planet."
  - *feeling:* deadpan gentle teasing — a deliberate kindness; letting him know his secret was never really a secret, and that she is not angry.
- **Avram:** "I'm the Hero and after I've defeated the Demon Lord, when I'm strong enough, I'm going to wipe every slave collar and every slave merchant off the face of this world."
  - *feeling:* a sworn vow; intensity building; this is the purpose of his life.
- **Avram:** "And then, somehow, I don't know how, arrange it so the slave trade doesn't just come back a hundred years later. | That's going to be the hard part, even if I can do the rest."
  - *feeling:* serious and thinking; admitting the hard part honestly, which is how she can tell the vow is real.
- **Avram:** "The nobles know, from what I heard. | They know the Summoned Heroes sometimes don't like what they see when they get here."
  - *feeling:* bitter; explaining the threat that shaped his whole plan.
- **Avram:** "I suspect the nobles of encouraging Heroes to confront Demon Lords too soon, trying behind the scenes for a mutual kill."
  - *feeling:* cold, considered suspicion he has never been able to tell anyone.
- **Avram:** "I couldn't trust anyone. | Had to grow in secret. | Needed protection while I learned to fight."
  - *feeling:* tired; his defense coming out in fragments; afraid it sounds like a mere excuse.
- **Avram:** "I couldn't think of any safer way than a slave with a magical loyalty collar. So I could free all the slaves later."
  - *feeling:* ashamed and unflinching; he hears how bad it sounds as he says it and says it anyway.
- **Avram:** "I, I figured, that awful slimeball would have bought you, if I didn't, and that made it, not okay, but a net benefit for you."
  - *feeling:* the reasoning sounds weaker spoken aloud than it did in his head, and he can hear that; he refuses to excuse himself even while explaining.
- **Avram:** "And I tried to treat you the best I possibly could. But I needed somebody to protect me, until I was strong enough, and I couldn't trust anyone -"
  - *feeling:* exhausted; the defense running out; helplessness.
- **Her:** "Yeah, I get it."
  - *feeling:* simple, real forgiveness; tired; she truly does understand and wants his spiral to stop.
- **Her:** "You know, I do wish you'd used my night services."
  - *feeling:* rueful honesty; looking back at what might have been easier. Not flirtation, not accusation.
- **Her:** "The collar, the only kind of thinking it allows, I kept worrying that I was doing something wrong. | That I wasn't good enough for you."
  - *feeling:* calmly naming the anxiety she lived with; slightly wondering at it, like examining an old injury.
...
- **Avram:** "I'm sorry, but - I don't regret that decision. | Making love to you and finding out the truth afterwards would have been horrible beyond imagining. It would have scarred me forever."
  - *feeling:* in pain, and honest even though honesty is costly here.
- **Avram:** "Even worse than this is going to, I mean."
  - *feeling:* plainly acknowledging that this conversation will wound him permanently.
- **Avram:** "I - I know I have some trouble with self-forgiveness, but - even I don't think I deserved that. | If I had to do it all over again, I still wouldn't have sex with you."
  - *feeling:* hesitant; a rare, effortful moment of being fair to himself; certain of the conclusion.
- **Her:** "I see. | I forgive you, then."
  - *feeling:* sincere, simple, conclusive; warmth; a settled decision.
- **Avram:** "What's your real name? Not the nickname I gave you or that slave ID code, your name from -"
  - *feeling:* warmth; he intends this as a kind gift — giving her back her identity — and has no idea he is touching her worst trauma.
- **Her:** "*Stop!* | Stop. | Don't remind me of that. | It's - that was one of the worst parts of the nightmare at the beginning, being punished, never to think of my old name -"
  - *feeling:* sudden panic, before thought, from her oldest wound; then catching herself, pulling herself back under control, and explaining while still shaken.
- **Avram:** "Never mind. I'm sorry."
  - *feeling:* instant retreat; horrified at what he touched.
- **Her:** "I should - I should go very soon. This is getting harder and harder."
  - *feeling:* ("go" means die.) The pain is rising past what her calm can hold, and she says so honestly, with apology in it; she wants to leave well, and the window for that is closing.
- **Avram:** "I don't suppose you'd want to stay, not to defeat the Demon Lord, but to wipe out the entire slave trade afterwards?"
  ...
  - *wants to appear:* light and casual, so that refusing costs her nothing.
...
- **Avram:** "It's not your fault. I'll free them for you."
  - *feeling:* immediate reassurance, then a renewed vow, now made to her personally; tenderness.
- **Avram:** "Is there - is, is there, anything else you want to say to me, or ask of me?"
  - *feeling:* wrecked but gentle; trying to keep the conversation alive a little longer, because he knows it is the last one.
- **Her:** "I don't understand you, Summoned Hero. I never did."
  - *feeling:* soft wonder; the title now carries fondness; she is beginning her goodbye.
- **Her:** "You seemed so sad and guilty and I never understood why."
  - *feeling:* tender puzzlement.
...
- **Her:** "I don't know what the laws of your world were like. | I imagine they must have been very harsh, in some ways, even if they were kindly in others."
  - *feeling:* gentle insight; she has understood that his own moral code punishes him; warmth and wisdom.
...
- **Her:** "Stop thinking that you're a horrible person, okay, Avram? Because you're not."
  - *feeling:* she says his name for the first and only time. Direct warmth and urgency; she needs this to land before she goes.
...
- **Avram:** "Okay."
  - *feeling:* complete defeat and complete love; a promise he does not believe he can keep, made because she asked.
- **Her:** "Goodbye, Master."
  - *feeling:* settled, grateful, calm; "Master" is now freely chosen and affectionate, not submissive; she is at peace and wants him to remember her that way.
  - *wants to appear:* at peace, so that he does not carry more guilt than he must.

---

## Chapter 13 — Change (Skagganauk close)

Same narrator as chapter 1, but now the story has been told. Slightly more warmth shows
through the calm, and at the very end he is openly warm and hopeful.
...
- **Skagganauk:** "At the poles of the world, there are two dungeon entrances that never fade, no matter how much time passes without challengers."
  - *feeling:* calm; deliberately steadying, resuming the tale after grief.
- **Skagganauk:** "Down and down go the stairs beyond, through level after level of dungeon, unto the very center of the World."
  - *feeling:* patience; the contentment of describing his own vast home.
- **Skagganauk:** "There upon a mountain of treasure inconceivable, lies the last boss of the last dungeon, |I, |myself, |the Void Dragon Skagganauk, |where I wait and watch and guard the last key."
  - *feeling:* revealing himself without vanity; enormous stillness; quiet amusement at stepping out from behind the narration.
...
- **Skagganauk:** "Always two they are, when they come to this place from elsewhere."
  - *feeling:* absolute certainty; stating a law of the world.
- **Skagganauk:** "When the world has stayed in its course too long, |when the boundaries of countries have stayed set, |when there are no more great discoveries in the academies of magic, |they come."
  - *feeling:* patience across centuries; a faint eagerness underneath, because change is what he waits for.
- **Skagganauk:** "And the dance of Summoned Hero and Demon Lord begins."
  - *feeling:* gravity; he knows what the dance costs the two people involved; the barest warmth.
...
- **Skagganauk:** "Of the two outsiders, there is one who chooses to protect the things that are, | and one who desires to change them."
  - *feeling:* careful even-handedness; he feels no judgment toward either side.
- **Skagganauk:** "I wish you the best of luck, Demon Lord. May the change you bring, be at last the truth that this world is forever seeking. |[]"
  - *feeling:* a sincere blessing, meant for Avram: respect, compassion, and real hope. Warmth, for the first and only time in the piece.
