...
STYLE = ("Visual novel background art, 16:9 full-screen, NO people, no characters, no text, no watermark. "
         "Clean anime-style painted background, crisp lineart edges, muted earthy palette. ")
...
BGS = {
    ...
    "bg_dungeon_mid": "A dungeon corridor, middle floors: precisely worked stone in a style no human culture built, subtly wrong geometry, narrower joints, faint carved patterns, cooler light from sparse torches. A place growing stranger.",
    "bg_dungeon_deep": "A dungeon depth, deep floors: a vast dark stone hall whose ceiling is lost in blackness, colossal columns, a faint sourceless blue-green glow along the floor seams. Cold, ancient, indifferent scale.",
